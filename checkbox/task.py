...
status = IntVar()
status.set(1)
box = Checkbutton(root, text="Вычислить процент от уточной нормы", variable=status)

output_for_day = Entry(root, width=3, font=("Calibri", 20))

percent = Label(root, text="%", font=("Calibri", 20))
